                                ...
                                <tbody style="align-items: center">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-uppercase text-center">
                                            <a class="btn btn-default " style="padding: 1px 8px 1px 8px;" href="#" title="voir" onclick="show_monitoring('http://127.0.0.1:8000/show_monitoring/${code}')" ><i class="glyphicon glyphicon-eye-open"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                              </table>

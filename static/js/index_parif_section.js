        ...
        $.ajax({
            ...
            success:function(response){
              ...
              if(response.id != "" && response.id_coop != ""){
                ...
                Promise.all([
                  fetch("http://192.168.1.250:8000/api/v1/section_parcelles/"+response.id),
                              ...
                              <tbody style="align-items: center">
                                  ...
                                  <tr>
                                      ...
                                      <td class="text-uppercase text-center">
                                          <a class="btn btn-default " style="padding: 1px 8px 1px 8px;" href="#" title="voir" onclick="show_monitoring('http://192.168.1.250:8000/show_monitoring/${code}')" ><i class="glyphicon glyphicon-eye-open"></i></a>
                                      </td>
                                  </tr>
                              </tbody>
                            </table>
                ...
                Promise.all([
                  fetch("http://192.168.1.250:8000/api/v1/coop_parcelles/"+response.id_coop),
                //  fetch("http://127.0.0.1:8000/api/parcelles?format=json")
                ]).then(async ([response1]) => {
                  const responseData1 = await response1.json();
                  //  const responseData2 = await response2.json();
